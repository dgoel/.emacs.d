;;; window-move.el --- Collection of functions to manage windows
;;;
;;;
...
(defun split-window-right-and-move-there-dammit ()
  "Split horizontally and move focus to the right"
  (interactive)
  (split-window-right)
  (windmove-right))
...
(defun toggle-window-split ()
  "Convert veritically split windows to a horizontal split"
  (interactive)
  (if (= (count-windows) 2)
